...
def parse_args():
    ...
    parser.add_argument("--output", "-o", help="output dataset, overrides default session config (eg. for testing)")
    parser.add_argument(
    ...
    parser.add_argument(
        "--skip-n-tasks", help="skip n of the tasks", default=0, type=int
    )
    parser.add_argument("--control-window", help="show control window", action="store_true")
    parser.add_argument(
        "--no-force-resolution",
