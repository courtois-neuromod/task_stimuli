...
ISI_mean = 2
ISI_base = 2
IMAGES_FOLDER = "/Users/xiaoxuanlei/Desktop/202209_MULTFS_mri/202209_MULTFS_MRI_Simple/MULTIF_4_stim"
...
Try to remember the items and their location on the screen."""
    ...
    def setup(
        ...
        self.fixation = visual.TextStim(exp_win, text="+", alignText="center", color="black")
